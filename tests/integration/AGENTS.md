...
- **GraphQL-launched E2E** tests that validate offline-first loops:
  ...
  - `join_asset_job` (join, asset-based): data-lake spatial + data-lake tabular → DuckDB join → data-lake joined + MongoDB ledger + lineage (both parents must be existing assets)
