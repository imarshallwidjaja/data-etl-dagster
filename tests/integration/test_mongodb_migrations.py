...
class TestMigrationDiscovery:
    ...
    def test_migrations_directory_exists(self):
        ...
        migrations_dir = Path(__file__).parent.parent.parent / "services" / "mongodb" / "migrations"
...
class TestMigrationIdempotency:
    ...
    def test_assets_validator_allows_tabular(self, mongo_database):
        ...
        # Try to insert a valid tabular asset
        tabular_asset = {
            "s3_key": "data-lake/test_dataset/v1/data.parquet",
            "dataset_id": "test_dataset",
            "version": 1,
            "content_hash": "sha256:" + "0" * 64,
            "dagster_run_id": "test_run_123",
            "kind": "tabular",
            "format": "parquet",
            "crs": None,
            "bounds": None,
