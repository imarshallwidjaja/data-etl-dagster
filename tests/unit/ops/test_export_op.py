...
from services.dagster.etl_pipelines.ops.export_op import (
    export_to_datalake,
    _export_to_datalake,
)
...
def test_export_to_datalake_success(
    ...
    with patch("builtins.open", mock_open(read_data=test_content)):
        ...
        result = _export_to_datalake(
            ...
            dagster_run_id="abc12345-def6-7890-abcd-ef1234567890",
    ...
    assert result["run_id"] == "507f1f77bcf86cd799439011"
    ...
    assert (
        "schemas=proc_abc12345_def6_7890_abcd_ef1234567890"
        in call_args.kwargs["input_path"]
    )
...
def test_export_to_datalake_asset_model_creation(
    ...
    assert asset_arg.run_id == "507f1f77bcf86cd799439011"
...
def test_export_to_datalake_op(
    ...
    # Mock insert_asset to return string id (real behavior)
    mock_mongodb.insert_asset.return_value = "507f1f77bcf86cd799439011"
    # Mock get_run_object_id to return string id (op calls this to get run_id)
