...
def valid_tabular_file_entry_dict():
    ...
    return {
        "path": "s3://landing-zone/batch_tabular/data.csv",
        "type": "tabular",
        "format": "CSV"
    }
...
def valid_asset_dict(valid_bounds_dict):
    """Complete valid spatial asset dictionary."""
    return {
        ...
        "metadata": {
            ...
            "source": "Test Source",
            "license": "CC-BY-4.0",
            "tags": {"project": "ALPHA", "source": "unit-test"},
            "header_mapping": None
        },
...
def valid_tabular_asset_dict():
    ...
    return {
        ...
        "dagster_run_id": "run_tabular_12345",
        "kind": "tabular",
        "format": "parquet",
        "crs": None,
        "bounds": None,
        "metadata": {
            ...
            "description": "A test tabular dataset for validation",
            "source": "Test Source",
            "license": "CC-BY-4.0",
            "tags": {"project": "ALPHA", "source": "unit-test"},
            "header_mapping": {"original_col": "cleaned_col", "Another Col": "another_col"}
        },
        "created_at": datetime(2024, 1, 1, 12, 0, 0),
        "updated_at": None
    }
