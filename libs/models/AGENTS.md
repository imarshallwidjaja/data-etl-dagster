...
- **Intent/type coherence**: `Manifest` enforces that `intent="ingest_tabular"` requires all files to be `type="tabular"`, `intent="join_datasets"` allows tabular files (primary dataset), and other intents forbid tabular files.
